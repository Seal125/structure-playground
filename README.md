...
- when starting to think of structure, what's the best thought process?
- **if imlpementing structure on an already existing project, how can we go about changing it w/o it being a super giant headache** (please do this once project is established) (as i wrote this i realize it might be dependent of initial structure anyway, so...it might be a hard ask to have it be less of a pain point but i would still like to try) (pretty sure theres already an answer to this but i wanna get it on my own :) )
